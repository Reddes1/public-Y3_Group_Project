...
void AudioManager::PauseLoopingSound(std::unique_ptr<DirectX::SoundEffectInstance>& loopSound)
{
	loopSound->Pause();
}

void AudioManager::ResumeLoopingSound(std::unique_ptr<DirectX::SoundEffectInstance>& loopSound)
{
	loopSound->Resume();
}
