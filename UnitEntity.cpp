...
void UnitEntity::SetSkillsBasedOnClass()
{
	...
	case GameClasses::ASSASSIN:
		SetBaseSkills(ClassSkills::M_BASIC, ClassSkills::SPEC_DAGGER,
			ClassSkills::PREMED_ATTACK, ClassSkills::EVASIVE_MAN);
		break;
	case GameClasses::BARBARIAN:
		SetBaseSkills(ClassSkills::M_BASIC, ClassSkills::WILD_SWING,
			ClassSkills::TAC_CHANGE, ClassSkills::RESIL_BODY);
		break;
	case GameClasses::ARCHER:
		SetBaseSkills(ClassSkills::R_BASIC, ClassSkills::POWER_SHOT,
			ClassSkills::MINOR_HEAL, ClassSkills::HUNTER_FOCUS);
		break;
	case GameClasses::NECROMANCER:
		SetBaseSkills(ClassSkills::R_BASIC, ClassSkills::UCN_BLAST,
			ClassSkills::NECRO_SWING, ClassSkills::SOUL_ARMOUR);
		break;
	case GameClasses::SORCERESS:
		SetBaseSkills(ClassSkills::R_BASIC, ClassSkills::FIREBALL,
			ClassSkills::ARCANE_EXPLO, ClassSkills::ARCANE_FOCUS);
		break;
	case GameClasses::WARRIOR:
		SetBaseSkills(ClassSkills::M_BASIC, ClassSkills::MOD_HEAL,
			ClassSkills::MAJOR_HEAL, ClassSkills::SMITE);
		break;
	}
}
...
void UnitEntity::ResetBuffValues()
{
	m_CurrentBuffs.PhysDamageBuff	= 1.0f;
	m_CurrentBuffs.MagDamageBuff	= 1.0f;
	m_CurrentBuffs.PhysHitBuff		= 1.0f;
	m_CurrentBuffs.MagHitBuff		= 1.0f;
	m_CurrentBuffs.PhysArmourBuff	= 1.0f;
	m_CurrentBuffs.MagArmourBuff	= 1.0f;
	m_CurrentBuffs.MagResistBuff	= 1.0f;
	m_CurrentBuffs.CritHitBuff		= 1.0f;
	m_CurrentBuffs.CritDamageBuff	= 1.0;
	m_CurrentBuffs.EvasionBuff		= 1.0f;
	m_CurrentBuffs.MovespeedBuff	= 1.0f;
	m_CurrentBuffs.TurnCount		= 0;
	SetBuffState(false);
	UpdateTotalValues();
}
